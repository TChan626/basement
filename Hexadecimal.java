...
public class Hexadecimal implements Comparable {
	...
	//initialize return value to 1's digit
	String retStr = HEXDIGITS.substring( n % 16, n % 16 + 1 );

	while( n >= 16 ) {
	    n /= 16;
  	    //push a digit onto left side of growing return String
    ...
    /*=====================================
      String decToHexR(int) -- recursively converts base-10 input to hexadecimal
      pre:  n >= 0
      post: returns String of hex digits
      eg  decToHexR(0) -> "0"
          decToHexR(1) -> "1"
	...
	if ( n < 16 ) //base case: single hex digit
	    retStr = HEXDIGITS.substring( n, n + 1 );

	else  //concatenate hex 1's digit onto right side of hex rest-of-number
	    retStr = decToHexR( n / 16 ) + decToHexR( n % 16 );
